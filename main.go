// Sample firebase_quickstart demonstrates how to connect to Firebase, and add and list documents.
package main
...
func main() {
	...
	case *add:
		err := ref.Set(ctx, map[string]Products{
			"Tatli": {
				Name:  "Baklava - Fistikli ",
				Price: 1024,
			},
			"TatliV2": {
				Name:  "Baklava - Cevizli",
				Price: 65500,
			},
			"TatliV3": {
				Name:  "Baklava",
	...
	case *update:
		err := ref.Child("Tatli").Set(ctx, Products{
			Name:  "Baklava - Fistikli",
			Price: 38000,
		})
		if err != nil {
	...
	case *delete:
		err := ref.Child("Baklava - Fistikli").Delete(ctx)
		if err != nil {
